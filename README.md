...
python app.py --chat_model model/qwen2-1.5B-INT4 --embedding_model model/bge-small-FP32 --data_folder data --device CPU

C:/Users/Reji/AppData/Local/Programs/Python/Python311/python.exe start_web_interface.py --host 127.0.0.1 --port 5000
